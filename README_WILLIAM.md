...
Since we had both "wide" and "narrow" crime datasets to compare, we chose the independence "Student's t-test" (comparing the means of one population with the mean of another). 
